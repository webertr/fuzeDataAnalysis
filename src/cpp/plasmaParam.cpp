...
int testPlasmaParam() {
  ...
  double bField = 1E4;
  double centerWL = 500E-9;
  double widthWL = 500E-9;
  double temperature = 1;
  double ionDensity = 1E17;
  double mu = 2;
  double density = 1E17;
  
  gyroFrequencies(bField);
  carbonIonTemperature(centerWL, widthWL);
  gyroRadius(bField, temperature);
  alfvenVelocity(bField, ionDensity, mu);
  debyeLength(temperature, density);
