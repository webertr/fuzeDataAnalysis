...
/******************************************************************************
 * Function: save3VectorData
 * Inputs: gsl_vector*, gsl_vector*, gsl_vector*, char *
 * Returns: int
 * Description: This will first delete the file that it is passed, then save 
 * the 3 vectors in a single text file for gnuplot to plot 
 ******************************************************************************/
...
/******************************************************************************
 * Function: save4VectorData
 * Inputs: gsl_vector*, gsl_vector*, gsl_vector*, gsl_vector *, char *
 * Returns: int
 * Description: This will first delete the file that it is passed, then save 
 * the 4 vectors in a single text file for gnuplot to plot 
 ******************************************************************************/
...
int save7VectorData(gsl_vector *vec1In, gsl_vector *vec2In, gsl_vector *vec3In,
		    gsl_vector *vec4In, gsl_vector *vec5In, gsl_vector *vec6In, 
		    gsl_vector *vec7In, char *fileName) {
  ...
  for (ii = 0; ii < vec1In->size; ii++) {
    ...
    fprintf(fp, "%g\t%g\t%g\t%g\t%g\t%g\t%g\n", gsl_vector_get(vec1In, ii), 
	    gsl_vector_get(vec2In, ii), gsl_vector_get(vec3In, ii), gsl_vector_get(vec4In, ii),
	    gsl_vector_get(vec5In, ii), gsl_vector_get(vec6In, ii), gsl_vector_get(vec7In, ii));
