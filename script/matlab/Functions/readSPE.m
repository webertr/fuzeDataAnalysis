% readSPE.m
function [image,center_wave,res_wave] = readSPE(dirPath, filename)
...
% Get information about wavelenght dimension:
center_wave = getData(fd, '48', 'float32');     %first dim
res_wave = getData(fd, '4E', 'float32');     %first dim
